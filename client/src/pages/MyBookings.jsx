...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        <Title title='My Bookings' subTitle='Easily manage your past, current,and uppcoming hotel reservations in one place. Plan your trips seamlessly with
        just a few clicks' align='left'/>

        <div className='max-w-6xl mt-8 w-full text-gray-800'>

            <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b
            border-gray-300 dont-medium text-base py-3'>
                ...
                border-gray-300 py-6 first:border-t'>
                    ...
                    <div className='flex flex-col md:flex-row'>
                        ...
                        <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                            <p className='font-palyfair text-2xl'>{booking.hotel.name}
