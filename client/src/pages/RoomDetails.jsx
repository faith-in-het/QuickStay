...
const RoomDetails = () => {
    ...
    return room &&(
    <div className='py-28 md:py35 px-4 md:px-16 lg:px-24 xl:px-32'>
        {/* Room Details */}
        ...
        {/* Hosted By */}
        <div className='flex flex-col items-start gap-4 mt-30'>
            ...
            <button className='px-6 py-2.5 mt-4 rounded text-whitw bg-primary 
